    ...
    return (
      <div className="min-h-screen relative">
        ...
        <div
          ...
          style={{
            backgroundImage: "url(/school-outdoor.jpg)",
            ...
            <Card className="border-amber-200 bg-amber-50">
              ...
              <CardContent className="space-y-3 text-sm text-amber-900">
                <p>
                  ...
                  correct. I undertake to comply with the conditions, rules, regulations and decisions of the Future
                  Focus Learning Centre and any amendments thereto, which may be applicable to learners in general and
                  in the field which I am/we are registered.
                </p>
                <p>
                ...
                <p>
                  <strong>3.</strong> I/We agree that the monthly fees are to be paid in advance, whether upon receipt
                  of invoice or by the 1st of every month and that registration fee are non-refundable.
                </p>
                <p>
                ...
                <p>
                  ...
                  on the application form and may make any enquiries it deems necessary, including credit worthiness
                  with any credit bureau and previous schools/centres.
                </p>
