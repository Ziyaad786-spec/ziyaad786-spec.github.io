        ...
        <div className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-all duration-300 animate-scale-in max-w-2xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              We also provide Grade 12 programmes designed specifically for school leavers seeking to complete their
              matric and achieve their National Senior Certificate.
            </p>
